...
module.exports = {
  ...
  async login(req, res) {
    ...
    Valida.Valida_login(Email, Pass).then(function (results) {
      res.send(results);
    });
  },
  ...
  async company_login(req, res) {
    ...
    Valida.Valida_login_empresa(Email, Pass).then(function (results) {
      res.send(results);
    });
  },
  ...
  async company(req, res) {
    ...
    companyController.Company(idempresa).then((results) => res.send(results));
  },

  async company_all(req, res) {
    companyController.Company_All().then((results) => res.send(results));
  },

  async partnerships(req, res) {
    companyController.Partnerships().then((results) => res.send(results));
  },
  ...
  async List_Lojas(req, res) {
    listController.User_Login().then((results) => res.send(results));
  },

  async List_Pedidos(req, res) {
    const { id } = req.body;
    listController.List_pedido(id).then((results) => res.send(results));
  },

  async List_Pedidos_Inativo(req, res) {
    const { id } = req.body;
    listController.List_pedido_Inativo(id).then((results) => res.send(results));
  },

  async order_details(req, res) {
    const { id } = req.body;
    orderController.Order_Details(id).then((results) => res.send(results));
  },
  ...
  async order_status(req, res) {
    const { id } = req.body;
    orderController.Order_Status(id).then((results) => res.send(results));
  },
  ...
  async Last_Product(req, res) {
    const { id } = req.body;
    productController.Last_Product(id).then((results) => res.send(results));
  },
  ...
  async category(req, res) {
    productController.Category().then((results) => res.send(results));
  },
  ...
  async species(req, res) {
    productController.Species().then((results) => res.send(results));
  },

  async breed(req, res) {
    const { id_species } = req.body;
    productController.Breed(id_species).then((results) => res.send(results));
  },
  ...
  async Compra(req, res) {
    ...
    const { empresa_id_pedido } = req.body;
    const { usuario_id_pedido } = req.body;
    const { endereco_usuario_id_pedido } = req.body;
    const { idusuario_pedidos } = req.body;
    const { status } = req.body;
  ...
  async Cadastra_pedido(req, res) {
    const { valorItem } = req.body;
    const { QtdeItem } = req.body;
    const { IdProduto } = req.body;
  ...
  async status_pedido(req, res) {
    const { data_status } = req.body;
    const { pedido_id_status } = req.body;
